  ...
  return (
    <Row className="g-3 w-100">
      <Col md={6} className="min-w-0">
        <Tabs className="invoice-page-tabs-border invoice-page-tabs">
      ...
      <Col md={6} className="min-w-0">
        <Tabs activeKey={active} onSelect={(t) => setActive(t!)} className="invoice-page-tabs-border invoice-page-tabs">
